...
<br>
The reasons <i>why</i> AI hallucinated probably include because it prirotitized a plausible sounding narrative over giving the a factually correct answer. But <b>AI also hallucinated because of the way it was asked to address the issues of the person's "blur" and resume.</b> It's not fair to only blame AI in this situation. People make a lot of mistakes using AI, including writing prompts that make it more likely AI will hallucinate. Don't ever blame AI, it's only doing what it's told to do. Learn to avoid the mistakes people make when using AI, such as prompts that make it more likely to hallucinate.<br>
<br>
