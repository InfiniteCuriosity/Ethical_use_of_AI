...
The Human-in-the-Loop: An Ethical Checklist<br><br>
Before you hit "send," "publish," or "submit" on any content generated with the help of AI, run it through this three-point integrity check. These steps ensure that the AI remains your tool, not your proxy.<br><br>
<b>Verify for Accuracy</b>: Have I personally tested and validated the claims, data, and citations produced by the AI? (AI can hallucinate plausible-sounding falsehoods; never take its output as ground truth.)<br>
...
<h2>Here is how to set up a team of rivals for AI to generate an image, but you can do the same for any type of content your AI system accepts:</h2><br>
*****<br>
...
<br>
I'm going to publish this article in my blog and on LinkedIn:
<br>
https://github.com/InfiniteCuriosity/Ethical_use_of_AI/blob/main/Ethical_Use_of_AI.md.
<br>
...
I was working to recruit for an open position in accounts receivable. I had a good candidate and wrote a very good résumé. The recruiter in charge asked me to write a blurb, in addition to submitting the resume. A "blurb" is a summary that we would give to the company in addition to the job candidate's resume. My blurb had seven sentences and was perfectly accurate. The recruiter in charge passed the information through an AI system. The AI Version of the blurb was also seven sentences, but it contained seven errors. Five of those were grammar that a native English speaker would not make. The other two were extremely incorrect facts. One was saying that this person had skills that they did not have. The second was saying that this person received an award at a previous job, but that was actually not true. None of that was in anything I gave the recruiter in charge, because it's totally false. I told recruiter in charge that we could not use the AI generated material until it had been corrected for all the mistakes AI made.<br>
<br>
The reasons <i>why</i> AI hallucinated probably include because it prirotitized a plausible sounding narrative over giving the a factually correct answer. But <b>AI also hallucinated because of the way it was asked to address the issues of the job seeker's "blurb" and resume.</b> It's not fair to only blame AI when AI hallucinates or makes mistakes. People make a lot of mistakes using AI, including writing prompts that make it more likely AI will hallucinate. Don't ever only blame AI, it's only doing what it's told to do. You are the source, not AI. Learn to avoid the mistakes people make when using AI, such as prompts that make it more likely AI will hallucinate, make mistakes, or make content that is not real, verifiable or ethical.<br><br>
In other words, if you are wondering what contributed to AI hallucinating (or other errors attributed to AI), I strongly agree with Taylor Swift: <a href = https://www.youtube.com/watch?v=b1kbLwvqugk>"It's me"</a><br>
<br>
...
<br><br>
Woodfield was Apple's fifth retail store in the world. Google Gemini Pro did an amazing job scraping the data on the reviews, summarizing everything, giving me charts and tables. All good.<br><br>
...
<br>
<b><h3>Russ Recommendation: Never again ask AI about anything without first setting up a very successful team of rivals in the prompt you give to AI. The payoff from setting a team of rivals in your AI prompt is the biggest payoff you can get from AI if you set up the team of rivals well (and we'll see how to do that in just a moment). Let's look at some examples!!</b><br></h3>
<br>
<h4>1. First things first. ALWAYS start by telling the AI system it is a very successful team of rivals, list who is on the team. Include a critic, and (at least) one person chosen by AI</h4>
...
After I wrote this I realized there is one more critical role I want on the team that I did not have previously. <b>I require an <a href = "https://en.wikipedia.org/wiki/Ethics">ethicist</a> as part of all of my teams of rivals.</b> I definitely always want an experienced ethicist on every team of rivals I create using AI.<br>
<br>
...
"I am interested in this job. Create resumes of three top candidates who are very likely to get hired for this role. Let me know if there are any questions."<br><br>
...
You get the idea!
<br><br>
2. Now use the AI prompt from above to get recommendations to improve <b>YOUR</b> resume! Now you know the goal for this situation, let AI give you the recommendations to do your very best!<br>
<br>
...
<br>
<h2>How to test if something has been produced by AI</h2><br>
You know the drill by now! Open up your AI system and give it a prompt. Set up a team of rivals, ask the members of the team how likely it is the 'thing' was produced by AI, rank and rate the results. You know the whole process. Ask AI if content (text, images, music, video, etc.) was produced by AI and AI will tell you. That's one thing AI is actually good at doing: Responding to what it is asked to do. Prepare to be shocked how much content is produced by AI if you test content for AI production.<br><br>
...
Compare the three recommendations against my gold standard example. Produce a table of strengths and weaknesses for each of the recommendations. 
...
<br>
Let me know if there are any questions, I'm happy to work together.<br><br>Thank you!<br>
<br>
Russ Conte<br>
Forest Park, IL
